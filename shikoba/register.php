                                        ...
                                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            ...
                                            <form method="POST" class="mx-1 mx-md-4">
                                                <p class="mb-5 pb-lg-2 text-dark"
                                                   style="color: rgba(255,255,255,0.83);">Zaten hesabınız var mı? <a
                                                            href="login.php" style="color: #cccc00;">Giriş Yap</a></p>
                                                ...
                                                <div class="form-check d-flex justify-content-center mb-5">
                                                    ...
                                                    <label class="form-check-label" for="form2Example3">
                                                        <a href="#!" style="color: #cccc00;">Kullanım ve Gizlilik
                                                            şartlar</a>'ını okudum ve kabul ediyorum
                                                    </label>
                                                </div>
                                                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                    <button type="submit" class="btn btn-primary btn-lg">Kayıt Ol
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
